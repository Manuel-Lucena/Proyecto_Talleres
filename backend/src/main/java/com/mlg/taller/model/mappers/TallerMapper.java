...
public interface TallerMapper {
     ...
     * @mapping nombreCompletoProfesor Lógica condicional para evitar NullPointerException si no hay profesor.
     * @mapping plazasDisponibles Por defecto inicializa con el máximo (la lógica de resta reside en el Service).
     */
     ...
     * Ignora campos sensibles como 'activo' o 'fotoRuta' que requieren lógica de negocio.
     */
