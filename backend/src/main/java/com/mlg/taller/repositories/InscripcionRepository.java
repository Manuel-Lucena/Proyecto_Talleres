...
/**
 * Repositorio para la gestión de matrículas, estados de pago y control de aforo.
 * * Implementa un sistema híbrido de eliminación:
 * - ADMIN: Borrado físico (Hard Delete) total mediante Native Query.
 * - PROFE: Borrado lógico (Soft Delete) mediante actualización del campo 'activa'.
 */
@Repository
public interface InscripcionRepository extends JpaRepository<Inscripcion, Long> {
    ...
    /**
     * Busca una inscripción específica por usuario y taller saltándose los filtros de Hibernate.
     *
     * @param idUsuario Identificador del alumno.
     * @param idTaller  Identificador del taller.
    ...
    Optional<Inscripcion> findByUsuarioIdAndTallerId(@Param("idUsuario") Long idUsuario, @Param("idTaller") Long idTaller);
    ...
    /**
     * Obtiene todas las inscripciones de un taller (activas e inactivas) para gestión administrativa.
     *
     * @param idTaller Identificador del taller.
    ...
    /**
     * Obtiene el historial completo de un usuario (activas e inactivas) para gestión administrativa.
     *
     * @param idUsuario Identificador del alumno.
     ...
     * El registro permanece en la base de datos pero con el estado 'activa' a false.
     *
    ...
    /**
     * Realiza una eliminación física (Hard Delete) del registro en la base de datos.
