...
public interface EntregaRepository extends JpaRepository<Entrega, Long> {
     ...
     * @return Lista de todas las entregas de los alumnos para dicha tarea (Vista Profesor).
     */
     ...
     * @return Un {@link Optional} que contiene la entrega si existe, o vacío si el alumno aún no ha entregado.
